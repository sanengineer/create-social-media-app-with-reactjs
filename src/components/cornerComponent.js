    ...
    return (
      ...
      >
        ...
        <div className="dashboard-link f-12">
          ...
          <NavDropdown.Item href="/chats/inbox" className="pt-2 pr-2 pb-2 pl-2">
          ...
          >
            ...
            <span className="text-left">Journals</span>
          </NavDropdown.Item>

          <NavDropdown.Item
            href={`/${whoami.username}/storage`}
            className="pt-2 pr-2 pb-2 pl-2"
          >
            <span className="icon-setting">
              <svg
              ...
              >
                <path
                  d="M18.42 9.21003C17.8083 7.80584 16.753 6.64103 15.4157 5.89419C14.0785 5.14735 12.5333 4.8597 11.0169 5.07536C9.50051 5.29101 8.09671 5.99806 7.02073 7.08809C5.94475 8.17813 5.25597 9.59098 5.06001 11.11C4.1066 11.3384 3.27023 11.9089 2.70975 12.7132C2.14927 13.5176 1.9037 14.4998 2.01968 15.4732C2.13566 16.4467 2.60511 17.3437 3.33888 17.9939C4.07265 18.6441 5.01964 19.0021 6.00001 19H17C18.1994 18.9967 19.3576 18.5624 20.2634 17.7763C21.1692 16.9902 21.7623 15.9047 21.9345 14.7178C22.1066 13.5308 21.8464 12.3216 21.2012 11.3105C20.5561 10.2994 19.569 9.55396 18.42 9.21003ZM17 17H6.00001C5.46958 17 4.96087 16.7893 4.5858 16.4142C4.21073 16.0392 4.00001 15.5305 4.00001 15C4.00001 14.4696 4.21073 13.9609 4.5858 13.5858C4.96087 13.2107 5.46958 13 6.00001 13C6.26523 13 6.51958 12.8947 6.70712 12.7071C6.89466 12.5196 7.00001 12.2652 7.00001 12C7.00257 10.8173 7.4243 9.67379 8.19028 8.77262C8.95627 7.87145 10.0169 7.27098 11.1838 7.07791C12.3506 6.88483 13.5481 7.11164 14.5636 7.71804C15.579 8.32444 16.3466 9.27117 16.73 10.39C16.7887 10.56 16.8921 10.711 17.0294 10.8272C17.1666 10.9433 17.3327 11.0203 17.51 11.05C18.243 11.1853 18.8994 11.5886 19.3513 12.1813C19.8033 12.774 20.0183 13.5138 19.9547 14.2564C19.891 14.9991 19.5532 15.6914 19.007 16.1986C18.4608 16.7058 17.7453 16.9915 17 17Z"
                  fill="black"
                />
              </svg>
            </span>
            <span className="text-left">Storage</span>
          </NavDropdown.Item>
          <NavDropdown.Item
            href="/edit-profile"
            className="pt-2 pr-2 pb-2 pl-2"
